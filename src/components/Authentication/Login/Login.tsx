...
import {
  ...
  LoginModalState,
  FormikReturnProps
} from '../../../../interfaces/Authentication/Login/Login'
...
export default function LoginForm() {
  ...
  const submitForm = (values: { email: any; password: any }) => {
    ...
    }).then(loginDataHandler)
  }

  const successLoginNotification = () => {
    _notification['success']({
      message: 'Login Sucess',
      description: 'You\'re now log in your account.'
    })
  }

  return (
    <div>
      <Button color={'primary'} onClick={openModal} style={{ margin: '0px' }}>
        Login
      </Button>
      <Formik
