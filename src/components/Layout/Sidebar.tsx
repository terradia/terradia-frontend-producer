...
const Sidebar = () => {
  ...
  return (
    ...
    >
      ...
      <Menu.Item
        key={'/Categories'}
        onClick={() => OnClickedLink('/Categories')}
      >
      ...
      <Menu.Item
        key={'/Statistics'}
        onClick={() => OnClickedLink('/Statistics')}
      >
        <Icon component={() => <Statistics width={'25px'} height={'25px'} />} />
        <span style={textStyle}>Statistics</span>
      </Menu.Item>
      ...
      <Menu.Item key={'/Documents'} onClick={() => OnClickedLink('/Documents')}>
        ...
        <span style={textStyle}>Documents</span>
      </Menu.Item>
    </Menu>
  )
}
